...
<body class="font-poppins antialiased bg-gray-100 dark:bg-gray-900">
    ...
    <div x-data="reservationModal()" class="flex items-center justify-center md:mt-6">

        {{-- card --}}
        <div class="relative flex flex-col md:rounded-xl bg-white bg-clip-border text-gray-700 shadow-md max-w-2xl">
            ...
            <div class="p-6 pt-0">
                ...
                <form x-ref="resForm" method="POST" action="{{ route('reservations.store') }}">
                    @csrf
                    ...
                    <div class="grid grid-cols-4 gap-3">
                        ...
                        @while ($start <= $end)
                            ...
                            <button type="button" @click="selectTime('{{ $timeValue }}')"
        ...
        <div x-show="open" x-cloak x-transition.opacity
            ...
            <div class=" bg-white rounded-lg shadow-xl w-11/12 md:w-1/2  max-w-4xl p-6
                ...
                <div class="mt-6 flex justify-end gap-3">
                    ...
                    <button class="px-4 py-2 bg-pink-500 text-white rounded" @click="confirm()">
                        Confirm
                    </button>
                </div>
            </div>
